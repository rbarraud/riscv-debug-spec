...
harts than just the ones that are selected. Note that when unselected harts are
reset as the result of a reset request, there will be no indication in
\Fanyhavereset or \Fallhavereset until one of those harts becomes selected.
